 ...
 * </p>
 * 
 * Provides methods to input and display bike-specific information along with the general vehicle details.
 * 
...
public class Bike extends Vehicle {
	...
	/**
     * Default constructor.
     * Initializes the bike with default values.
     */
	public Bike() {
		super();
		hasGear = false;
     ...
     * Initializes the bike with provided values, including brand, model,
     * rental price, gear availability, and engine capacity.
     * 
     ...
     * <p>
     * Collects input for inherited vehicle attributes and bike-specific fields such as gear status
     * and engine capacity.
     * </p>
     */
    @Override
