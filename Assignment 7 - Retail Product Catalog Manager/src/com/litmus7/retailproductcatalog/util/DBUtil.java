...
import com.litmus7.retailproductcatalog.constant.DBConstants;
...
public class DBUtil {
	 ...
	 */
	static {
		try (InputStream input = DBUtil.class.getClassLoader().getResourceAsStream(DBConstants.DB_PROPERTIES_FILE)) {
